...
@interface XXBCircleSpreadTransition()<CAAnimationDelegate>

@end

@implementation XXBCircleSpreadTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    switch (_type) {
        case XXBCircleSpreadTransitionTypePresent:
            [self presentAnimation:transitionContext];
            break;
        case XXBCircleSpreadTransitionTypeDismiss:
...
- (void)dismissAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    if ([toVC isKindOfClass:[UITabBarController class]]) {
        toVC = toVC.viewControllers.lastObject;
    }
    XXBCircleSpreadController *temp = toVC.viewControllers.lastObject;
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    if ([fromVC isKindOfClass:[UITabBarController class]]) {
        fromVC = fromVC.viewControllers.lastObject;
    }
    XXBCircleSpreadController *temp = fromVC.viewControllers.lastObject;
    UIView *containerView = [transitionContext containerView];
